...
import 'package:pcbuilderec/services/pc_service.dart';
...
class PcBD extends StatefulWidget {
  const PcBD({
    Key? key,
  }) : super(key: key);

  @override
  State<PcBD> createState() => _PcBDState();
}

class _PcBDState extends State<PcBD> {
  @override
