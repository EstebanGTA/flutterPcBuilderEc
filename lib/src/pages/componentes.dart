...
import 'package:pcbuilderec/services/componentes_service.dart';
...
class ComponentesBD extends StatefulWidget {
  const ComponentesBD({
    Key? key,
  }) : super(key: key);

  @override
  State<ComponentesBD> createState() => _ComponentesBDState();
}

class _ComponentesBDState extends State<ComponentesBD> {
  @override
