...
class AddAccesorios extends StatefulWidget {
  const AddAccesorios({super.key});

  @override
  State<AddAccesorios> createState() => _AddAccesoriosState();
}

class _AddAccesoriosState extends State<AddAccesorios> {
