...
class LicenciasBD extends StatefulWidget {
  const LicenciasBD({
    Key? key,
  }) : super(key: key);

  @override
  State<LicenciasBD> createState() => _LicenciasBDState();
}

class _LicenciasBDState extends State<LicenciasBD> {
  @override
