...
import 'package:pcbuilderec/services/firebase_service.dart';
...
class LaptopBD extends StatefulWidget {
  const LaptopBD({
    Key? key,
  }) : super(key: key);

  @override
  State<LaptopBD> createState() => _LaptopBDState();
}

class _LaptopBDState extends State<LaptopBD> {
  @override
